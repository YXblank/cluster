...
COCO_MODEL_PATH = os.path.join(ROOT_DIR, "mask_rcnn_coco.h5") #? change from mask_rcnn_coco.h5 to mask_rcnn_shapes_0002.h5
...
class CocoConfig(Config):
    ...
    IMAGES_PER_GPU = 1 #? change from 2

    # Uncomment to train on 8 GPUs (default is 1)
    # GPU_COUNT = 8

    # Number of classes (including background)
    #? change from 1+80 to 1+8
