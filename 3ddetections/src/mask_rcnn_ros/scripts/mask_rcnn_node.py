...
COCO_MODEL_PATH = os.path.join(ROS_HOME, 'mask_rcnn_coco.h5') #? change from mask_rcnn_coco to mask_rcnn_shapes_0010.h5
...
""" CLASS_NAMES = [ 'cabinet', 'chair', 'door', 'stool', 'television',
               'window','dustbin','signboard'] """
